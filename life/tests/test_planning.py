...
class AutomaticPlanningTests(TestCase):
    ...
    def test_planning_page_loads_for_authenticated_user(self):
        ...
        self.assertContains(response, 'class="bottom-navigation"')
