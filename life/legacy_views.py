...
from .selectors.planning import available_calendar_tasks, eligible_planner_tasks
...
def planning(request):
    ...
    if (
        ...
        planner_tasks = eligible_planner_tasks(request.user)
...
# Fachada temporal: las URLs existentes siguen importando ``life.views``
# mientras cada dominio se traslada gradualmente a módulos independientes.
from .view_modules.auth import register as register
from .view_modules.areas import (
    life_area_create as life_area_create,
    life_area_delete as life_area_delete,
    life_area_detail as life_area_detail,
    life_area_edit as life_area_edit,
    life_area_list as life_area_list,
)
from .view_modules.plans import (
    plan_create as plan_create,
    plan_delete as plan_delete,
    plan_edit as plan_edit,
)
from .view_modules.tasks import (
    task_create as task_create,
    task_delete as task_delete,
    task_edit as task_edit,
)
